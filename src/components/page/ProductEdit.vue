                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.post(common.apidomain + "/product/edit.action?name=" + this.form.name +
                            ...
                            "&marketPrice=" + this.form.marketPrice + "&startTime=" + this.form.startTime +
                            "&endTime=" + this.form.endTime + "&num=" + this.form.num + "&orderTime=" +
                            this.form.orderTime + "&notice=" + this.form.notice + "&costInside=" + this.form
                            .costInside + "&costOutside=" + this.form.costOutside + "&remark=" + this.form.remark +
                            "&isSale=" + this.form.isSale + "&isCancel=" + this.form.isCancel + "&viewId=" +
                            this.form.viewId + "&method=" + this.form.method + "&sort=" + this.form.sort + "&id=" + this.form.id).then(
                            (res) => {
                                // console.log(res.data)
