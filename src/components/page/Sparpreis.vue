    ...
    export default {
        ...
        methods: {
            ...
            handleChange1(value) { //logic
                ...
                this.form.logic = parseInt(value);
            },
            onSubmit() {
                // console.log(this.$route.path)
                //console.log(this.form)
                axios.get(common.apidomain + "/view/findPageData.action?viewId=" + this.form.viewId + '&staffName=' +
                    this.form.staffName + '&viewName=' + this.form.viewName + '&level=' + this.form.level +
                    '&viewType=' + this.form.viewType + '&province=' + this.form.province + '&city=' + this.form.city +
                    '&logic=' + this.form.logic + '&pageIndex=' + this.pagingNowNumberList + "&power_id=" + JSON.parse(
                        window.sessionStorage.getItem("powerId")) + "&staff_id=" + JSON.parse(
                        window.sessionStorage.getItem("id"))).then((res) => {
            ...
            handleDownload() { //导出为Excel
                ...
                require.ensure([], () => {
                    ...
                    const filterVal = ['id', 'name', 'level', 'viewType', 'number', 'sort', 'businessTime',
                        'staffName',
                    ];
            ...
            getimgs() {
                ...
                axios.get(common.apidomain + "/view/findPageData.action?pageIndex=" + this.pagingNowNumberList +
                    "&power_id=" + JSON.parse(window.sessionStorage.getItem("powerId")) + "&staff_id=" + JSON.parse(
                        window.sessionStorage.getItem("id"))).then((res) => {
                    console.log(res.data);
                    this.tableData = res.data.data.datas; //表格数据
                    this.total = res.data.data.allCount; //条数
            ...
            handleCurrentChange(val) {
                // console.log(`当前页: ${val}`);
                axios.get(common.apidomain + "/view/findPageData.action?pageIndex=" + `${val}` + "&viewId=" + this.form
                    .viewId + '&staffName=' + this.form.staffName + '&viewName=' + this.form.viewName + '&level=' +
                    this.form.level + '&viewType=' + this.form.viewType + '&province=' + this.form.province +
                    '&city=' + this.form.city + '&logic=' + this.form.logic + "&power_id=" + JSON.parse(window.sessionStorage
                        .getItem("powerId")) + "&staff_id=" + JSON.parse(window.sessionStorage.getItem("id"))).then(
                    (res) => {
